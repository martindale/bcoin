...
var network = exports;
var main, testnet, regtest, segnet4, simnet, playnet;
...
network.types = ['main', 'testnet', 'regtest', 'segnet4', 'simnet', 'playnet'];
...
playnet = network.playnet = {};

playnet.type = 'playnet';
...
playnet.magic = 0xdab5bffa;

playnet.port = 48444;

playnet.checkpointMap = {};
playnet.lastCheckpoint = 0;

playnet.halvingInterval = 150;
...
playnet.activationThreshold = 108; // 75% for testchains

playnet.minerWindow = 144; // Faster than normal for playnet (144 instead of 2016)
...
playnet.deploys = [
  playnet.deployments.csv,
  playnet.deployments.segwit,
  playnet.deployments.mast,
  playnet.deployments.testdummy
];
...
playnet.requireStandard = false;

playnet.rpcPort = 48332;

playnet.minRelay = 1000;

playnet.feeRate = 20000;

playnet.maxFeeRate = 60000;

playnet.selfConnect = true;

playnet.requestMempool = true;
